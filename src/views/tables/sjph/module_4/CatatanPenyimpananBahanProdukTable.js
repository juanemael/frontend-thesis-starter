...
const CatatanPenyimpananBahanProdukTable = ({stepper, getSJPHInfo,  detailsSJPH, setCheckpoint}) => {
    ...
    const deleteCatatanPenyimpananBahanProdukGroupBySelfID = async (id) => {
        swal.fire({
            title: "Peringatan!",
            text: "Apakah kamu yakin ingin menghapus data ini?",
            icon: "warning",
            ...
            if (res.isConfirmed) {
                try {
                    const result = await bahanKepentinganHalalModel.deleteCatatanPenyimpananBahanProdukGroupBySelfID(id);
                    ...
                    <div className='d-flex'>
                        <UncontrolledDropdown>
                            ...
                            <DropdownMenu container={'body'} end>
                                ...
                                <DropdownItem className='w-100' onClick={()=>{ deleteCatatanPenyimpananBahanProdukGroupBySelfID(row.id) }}>
                                    <Trash size={15} />
    ...
    const submitTempatTanggal = async () => {
        const body = {
            tempat_persetujuan_catatan_penyimpanan_bahan_produk: tempatPersetujuan? tempatPersetujuan : detailsSJPH.tempat_persetujuan_catatan_penyimpanan_bahan_produk,
