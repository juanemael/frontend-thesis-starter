...
const CatatanPembelianBahanTable = ({stepper, getSJPHInfo,  detailsSJPH, setCheckpoint}) => {
    ...
    const deleteCatatanPembelianBahanGroupBySelfID = async (id) => {
        swal.fire({
            title: "Peringatan!",
            ...
            if (res.isConfirmed) {
                try {
                    const result = await bahanKepentinganHalalModel.deleteCatatanPembelianBahanGroupBySelfID(id);
                    ...
                    <div className='d-flex'>
                        <UncontrolledDropdown>
                            ...
                            <DropdownMenu container={'body'} end>
                                ...
                                <DropdownItem className='w-100' onClick={()=>{ deleteCatatanPembelianBahanGroupBySelfID(row.id) }}>
                                    <Trash size={15} />
